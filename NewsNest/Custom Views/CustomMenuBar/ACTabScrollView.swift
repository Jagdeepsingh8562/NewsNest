...
open class ACTabScrollView: UIView, UIScrollViewDelegate {
    ...
    @IBInspectable open var tabSectionBackgroundColor: UIColor = UIColor.systemBackground
    @IBInspectable open var contentSectionBackgroundColor: UIColor = UIColor.systemBackground
